...
<div class="header">
			<div class="top-head">
				<div class="top-head-first">
						...
						<a href="index.html"><p>(+374) 98-24-2895</p></a>

						    <hr>

							<span class="far"><i class="fas fa-envelope"></i></span>
							<a href="index.html"><p>mkrtchyanartak178@gmail.com</p></a>

							<hr>

							<span class="far"><i class="fas fa-map-marker-alt"></i></span>
							<a href="index.html"><p>Armenia, Gyumri</p></a>
					</div>
				...
				<div class="under-head">
					...
					<div class="head-button">
						<a href="index.html #4">	<button> Order <span style="font-style: italic;">service</span> </button></a>
					</div>
						</div>
				</div>
        ...
        <div class="footer">
        		...
        		<div class="footer-logo">
        				<div class="logo">
        						<a href="index.html"><i class="logo-icon fas fa-kaaba"></i></a>
        						<a href="index.html"><h1 style="color:#ffffff; ">Artcon <span class="fullstop">.</span></h1></a>
        					</div>
...
<?php /**PATH C:\OpenServer\domains\finish_project\resources\views/general/create.blade.php ENDPATH**/ ?>